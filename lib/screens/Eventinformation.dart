...
class _InformationPageState extends State<Eventinformation> {
  ...
  Future<void> initWebViewController() async {
    _webViewController = WebViewController()
      ...
      ..loadRequest(Uri.parse(widget.eventInfo.mapUrl));
    setState(() {
...
=======
import 'package:flutter/material.dart';
import 'package:mobileproject/screens/Wilaya_list_page.dart';
import 'GuidesInfoPage.dart';
import 'package:mobileproject/data/Eventdata.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:webview_flutter/webview_flutter.dart';
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Guide service coming soon!')),
                );
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => WilayaListPage()),
